      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-12">
        <div className="flex flex-col items-center justify-center gap-10">
          ...
          <div className="grid w-full max-w-5xl grid-cols-1 justify-items-center gap-8 lg:grid-cols-4">
              ...
              <div className="flex h-full flex-col justify-between gap-6 text-left font-medium text-white lg:p-6">
                ...
                <div className="font-red-hat-display flex flex-col gap-4 text-justify text-sm leading-relaxed text-zinc-300 md:text-base">
                  <p>
                    ...
                    decidí enfocearme a ello. Me gusta trabajar con TypeScript y
                    React.
                  </p>
                  <p>
                    Soy un desarrollador autodidacta y proactivo, enfocado en
                    creal soluciones eficientes, escalables y con un alto
            ...
            <img
              alt="Avatar"
              className="self-center object-contain transition-transform duration-300 hover:scale-105"
              src="/avatar.png"
              width={240}
            />
          </div>
